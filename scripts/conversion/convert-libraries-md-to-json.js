...
console.log("🔄 Converting Libraries.md to JSON format:");
console.log("===========================================");
console.log("");

// Read the markdown file
const markdownContent = fs.readFileSync('./SaltLakeCityResources/Libraries.md', 'utf8');

// Parse the markdown content into structured data
function parseLibrariesMarkdown(content) {
  const resources = [];
...
const librariesData = parseLibrariesMarkdown(markdownContent);

// Create the JSON structure - simplified without metadata
const jsonOutput = {
  category: "Libraries",
  totalResources: librariesData.length,
  resources: librariesData
};

// Write to JSON file
const outputPath = './SaltLakeCityResources/libraries.json';
fs.writeFileSync(outputPath, JSON.stringify(jsonOutput, null, 2));

console.log(`✅ Successfully converted ${librariesData.length} library resources to JSON`);
...
librariesData.forEach((resource, index) => {
