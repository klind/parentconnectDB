...
console.log("🔄 Converting Schools.md to JSON format:");
console.log("========================================");
console.log("");

// Read the markdown file
const markdownContent = fs.readFileSync('./SaltLakeCityResources/Schools.md', 'utf8');

// Parse the markdown content into structured data
function parseSchoolsMarkdown(content) {
  const resources = [];
...
const schoolsData = parseSchoolsMarkdown(markdownContent);

// Create the JSON structure - simplified without metadata
const jsonOutput = {
  category: "Schools",
  totalResources: schoolsData.length,
  resources: schoolsData
};

// Write to JSON file
const outputPath = './SaltLakeCityResources/schools.json';
fs.writeFileSync(outputPath, JSON.stringify(jsonOutput, null, 2));

console.log(`✅ Successfully converted ${schoolsData.length} school resources to JSON`);
...
schoolsData.forEach((resource, index) => {
