...
console.log("🔄 Converting Museums.md to JSON format:");
console.log("=========================================");
console.log("");

// Read the markdown file
const markdownContent = fs.readFileSync('./SaltLakeCityResources/Museums.md', 'utf8');

// Parse the markdown content into structured data
function parseMuseumsMarkdown(content) {
  const resources = [];
...
const museumsData = parseMuseumsMarkdown(markdownContent);

// Create the JSON structure - simplified without metadata
const jsonOutput = {
  category: "Museums",
  totalResources: museumsData.length,
  resources: museumsData
};

// Write to JSON file
const outputPath = './SaltLakeCityResources/museums.json';
fs.writeFileSync(outputPath, JSON.stringify(jsonOutput, null, 2));

console.log(`✅ Successfully converted ${museumsData.length} museum resources to JSON`);
...
museumsData.forEach((resource, index) => {
