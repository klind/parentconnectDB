...
async function removeAllChildrenAllergies() {
  try {
    console.log('🔄 Starting to remove all allergies from children...');
      ...
      try {
        ...
        if (!childrenSnapshot.empty) {
          ...
          for (const childDoc of childrenSnapshot.docs) {
            ...
            try {
              await childDoc.ref.update({ allergies: [] });
              console.log(`   ✅ Child ${childData.name || childDoc.id}: Allergies cleared`);
              updatedChildren++;
            } catch (error) {
    ...
    console.log('\n✅ All children allergies removed successfully!');
